...
// Base denztzyHw Mods : Copyan Dari Base Dika
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC denztzy`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 denztzy WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 denztzy WA 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
case 'bugpoll': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`denztzyAPIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`denztzyAPIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
{ urlButton: { displayText: `GROUP denztzy WA`, url: `https://chat.whatsapp.com/I6VMA8KF74gICjxESpThL2`}},
...
"retailerId": `© denztzyWE ARE NOT MASTOD`,
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} denztzyGans`
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
denztzy`, contextInfo:{"externalAdReply": {"title": `SC denztzy MODS`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏💧 [ jumlah ]
┗━━⊱`,
contextInfo:{"externalAdReply": {"title": `SC denztzy MODS`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
